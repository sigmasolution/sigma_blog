	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header asks-question">
				...
				<ul class="tabs-title">
					<li><h4 class="modal-title active" id="tab-question"><?php _e('Ask a Question',ET_DOMAIN) ?></h4></li>
					<?php if(ae_get_option('poll_maker') !=="0") { ?>
					<li><h4 class="modal-title" id="tab-poll"><?php _e('Create a Poll',ET_DOMAIN) ?></h4></li>
					<?php } ?>
				</ul>
			</div>
