                ...
                <ul>
                    <li>
                        <a class="<?php if (!isset($_GET['type'])) echo 'active'; ?>"
                           href="<?php echo get_author_posts_url($user->ID); ?>"><?php _e('Questions', ET_DOMAIN) ?></a>
                    </li>
                    <?php
                        if(ae_get_option('poll_maker') !=="0"){
                            ...
                            <li>
                                <a class="<?php if (isset($_GET['type']) && $_GET['type'] == "poll") echo 'active'; ?>"
                                   href="<?php echo esc_url(add_query_arg(array('type' => 'poll'))); ?>"><?php _e('Polls', ET_DOMAIN) ?></a>
                            </li>
                            <?php
                        }
                    ?>
                    <li>
                        <a class="<?php if (isset($_GET['type']) && $_GET['type'] == "answer") echo 'active'; ?>"
                           href="<?php echo esc_url(add_query_arg(array('type' => 'answer'))); ?>"><?php _e('Answers', ET_DOMAIN) ?></a>
                    </li>
                    <?php if ($current_user->ID == $user->ID) { ?>
                        <li>
                            <a class="<?php if (isset($_GET['type']) && $_GET['type'] == "following") echo 'active'; ?>"
                               href="<?php echo esc_url(add_query_arg(array('type' => 'following'))); ?>"><?php _e('Following', ET_DOMAIN) ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </div>
