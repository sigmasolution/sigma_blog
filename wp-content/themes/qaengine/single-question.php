    ...
    <div itemscope itemtype="http://schema.org/Question" class="col-md-8 main-content single-content">
        ...
        <div id="question_content" class="row question-main-content question-item" data-id="<?php echo $post->ID; ?>">
            ...
            <div class="col-md-9 col-xs-9 q-right-content">
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-8 question-cat" data-user="<?php echo $question->post_author;?>">
        ...
        <?php if ( is_user_logged_in() || !ae_get_option( 'view-answer' )) { ?>
                ...
                <div class="max-col-md-8">
                    ...
                    <div class="col-md-6 col-xs-6 sort-questions">
                        <ul>
                            ...
                            <!-- <li>
                            <a class="<?php echo isset($_GET['sort']) && $_GET['sort'] == 'active' ? 'active' : ''; ?>" href="<?php echo esc_url(add_query_arg(array('sort' => 'active'))); ?>"><?php _e("Active",ET_DOMAIN) ?></a>
                        </li> -->
                            <li>
                                <a class="<?php echo isset($_GET['sort']) && $_GET['sort'] == 'oldest' ? 'active' : ''; ?>" href="<?php echo esc_url(add_query_arg(array('sort' => 'oldest'))); ?>"><?php _e("Oldest",ET_DOMAIN) ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <?php }else{?>
            ...
            <div class="sticky-wrapper">
                <h3 style="  background: #E5E5E5;"><a class="login-url" href="javascript:void(0)" data-toggle="modal"><?php _e('Login or Register to view and post answer',ET_DOMAIN);?></a></h3>
                <div class=""></div>
            </div>
