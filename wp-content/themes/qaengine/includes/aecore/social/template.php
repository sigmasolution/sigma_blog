	...
	<?php } ?>
	    <form id="form_auth" method="post" action="">
	        <div class="social-form">
	            ...
	            <input type="text" name="user_email" value="<?php if(isset($auth['user_email'])) echo $auth['user_email']; ?>"  placeholder="<?php _e('Email', ET_DOMAIN) ?>">
...
function ae_social_auth_support_role() {
    $default = array('author'=> __('author',ET_DOMAIN), 'subscriber'=>__('subscriber',ET_DOMAIN), 'editor'=>__('editor',ET_DOMAIN), 'contributor'=>__('contributor',ET_DOMAIN));
