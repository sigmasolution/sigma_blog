...
class AE_Page extends AE_Base
{
    ...
    public function print_styles() {
        ...
        if( isset( $_GET['page'] ) && $_GET['page'] == "et-users" ) {
            $this->add_style('bootstrap', ae_get_url() . '/assets/css/bootstrap.min.css');
        }
    ...
    public function print_scripts() {
        ...
        if( isset( $_GET['page'] ) && $_GET['page'] == "et-users" ) {
            $this->add_script('bootstrap-js',  ae_get_url() . '/assets/js/bootstrap.min.js', array(
                'jquery'
            ));
        }
        ...
        $vars = apply_filters('ae_admin_globals', array(
            ...
            'integer_msg'     => __("You must enter an integer value.", ET_DOMAIN)
        ));
        wp_localize_script('appengine', 'ae_globals', $vars );
    }
...
class AE_Menu extends AE_Page
{
    ...
    function __construct($pages) {
        ...
        new AE_UserAction(new AE_Users());
        new AE_Language();
    ...
    function action_sync() {
        ...
        do_action('ae_before_save_option', $name, $value);
        /**
