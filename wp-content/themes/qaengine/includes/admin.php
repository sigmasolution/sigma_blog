...
class QA_Admin extends QA_Engine
{
    ...
    function __construct() {
        ...
        $this->add_action('ae_admin_user_action', 'admin_user_item');
    }
    /**
     *  overide underscore template tag
     * @author Dakachi
     * @package QAEngine
     * @since 1.0
    */
    ...
    /**
     * hook to action add more info to user item on list member in backend
     * @param Object $user
     * @return void
     * @since 1.5.5
     * @author  Dakachi
     */
    function admin_user_item( $user ) {
    ...
    function get_default_options() {
        ...
        return array(
            ...
            'pending_question_mail_template' => '<p>Hello Admin,</p>
                                                ...
                                                <p>Sincerely,<br />[blogname]</p>',
            //  default pending question mail template
            'accept_answer_mail_template'      =>   '<p>Hi [display_name],</p><p>Your answer has been [action] as the best answer.</p><p>You can view your answer by visit this link: [question_link],</p><p>Sincerely,<br />[blogname]</p>',
            ...
            // default register mail template
            'new_badges_mail_template'         => '<p>Hello [display_name],</p>
                                                ...
                                                <p>Sincerely,<br />[blogname]</p>',
            'down_badges_mail_template'         => '<p>Hello [display_name],</p>
    ...
    function admin_setup() {
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        ...
                        'id' => 'site-copyright',
                        'class' => '',
                        'desc' => __("This copyright information will appear in the footer.-Null24.Net", ET_DOMAIN)
                    ) ,
                ...
                array(
                    'args' => array(
                        ...
                        'id' => 'site-analytics',
                        'class' => '',
                        'desc' => __("Google analytics is a service offered by Google that generates detailed statistics about the visits to a website.-Null24.Net", ET_DOMAIN)
                    ) ,
                ...
                array(
                    'args' => array(
                        'title' => __("Administrator Email", ET_DOMAIN) ,
                        'id' => 'new_admin_email',
                        'class' => '',
                        'desc' => __("This email is used for admin purposes.", ET_DOMAIN)
                    ) ,
            ...
            'groups' => array(
                ...
                array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'placeholder' => __("Facebook Secret Key ID", ET_DOMAIN) ,
                            'class'       => ''
                        ),
                    ),
                ),
                array(
                    'args' => array(
                        ...
                        'id'    => 'google-api',
                        'class' => '',
                        'desc'  => __('Enabling this will allow users to login via Google.(<a target="_blank" href="https://code.google.com/apis/console">get key</a>)', ET_DOMAIN)
                    ) ,
                    ...
                    'fields' => array(
                        ...
                        array(
                            'id'          => 'gplus_client_id',
                            'type'        => 'text',
                            'title'       => __("Google client key", ET_DOMAIN) ,
                        ...
                        array(
                            ...
                            'placeholder' => __("Secret ID", ET_DOMAIN) ,
                            'class'       => ''
                        ),
                    ),
                ),
                array(
                    'args' => array(
                        'title' => __("Google Plus", ET_DOMAIN) ,
                        'id'    => 'google-api',
                        'class' => '',
                    ) ,
                ...
                array(
                    'args' => array(
                        'title' => __("Youtube URL", ET_DOMAIN) ,
                        'id'    => 'google-api',
                        'class' => '',
                    ) ,
        ...
        $sections[] = array(
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        'title' => __("Maximum length of title", ET_DOMAIN) ,
                        'id'    => 'max-width-title',
                        'class' => '',
                        'desc'  => __("Insert the maximum length of the title", ET_DOMAIN),
                    ) ,
                    ...
                    'fields' => array(
                        array(
                            ...
                            'default'=> 150,
                            'class' => 'option-item bg-grey-input number',
                            'min'   => 0,
                        ),
                    )
                ),
                ...
                array(
                    'args'  => array(
                        'title' => __("Infinite Scroll", ET_DOMAIN) ,
                        'id'    => 'infinite-scroll',
                        'class' => '',
                        'desc'  => __("Enabling this will activate the Infinite Scrolling.", ET_DOMAIN)
                    ) ,
                ...
                array(
                    'args' => array(
                        'title' => __("Login To View Answer",ET_DOMAIN),
                        'id'    => 'view-answer',
                        'class' => '',
                        'desc'  => __("If you enable this option, users have to login to see answer", ET_DOMAIN)
                    ),
                    'fields' => array(
                        array(
                            'id'    => 'view-answer',
                            'type'  => 'switch',
                            'title' => __('View answer',ET_DOMAIN),
                            'name'  => 'view-answer',
                            'class' => ''
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("Send Email From", ET_DOMAIN) ,
                        'id'    => 'send-email-from',
                        'class' => '',
                        'desc'  => __("This email will appear in the email's header", ET_DOMAIN)
                    ),
                    'fields' => array(
                        array(
                            'id'      => 'send_mail_from',
                            ...
                            'name'    => 'send_mail_from',
                            'class'   => 'email',
                            'default' => 'no-reply@enginethemes.com'
                        )
                    )
                )
            )
        ...
        $sections['url_slug'] = array(
            ...
            'groups' => array(
                array(
                    'args' => array(
                        'title' => __("Questions", ET_DOMAIN) ,
                        'id'    => 'questions-slug',
                        'class' => 'list-package',
                        'desc'  => __("Enter slug for your Single Question page (this slug must be unique, please re-save the permalink options after changed slug).", ET_DOMAIN) ,
                    ) ,
                    'fields' => array(
                        array(
                            'id'          => 'question-slug',
                            'type'        => 'text',
                            'title'       => __("Single Question page Slug", ET_DOMAIN) ,
                            'name'        => 'question_slug',
                            'placeholder' => __("Single Question page Slug", ET_DOMAIN) ,
                            'class'       => 'option-item bg-grey-input ',
                            'default'     => 'question'
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("Questions Category", ET_DOMAIN) ,
                        'id'    => 'questions-category-slug',
                        'class' => 'list-package',
                        'desc'  => __("Enter slug for your Question Category archive (this slug must be unique and can not be 'category', please re-save the permalink options after changed slug).", ET_DOMAIN) ,
                    ) ,
                    'fields' => array(
                        array(
                            'id'          => 'category-slug',
                            'type'        => 'text',
                            'title'       => __("Questions Category Slug", ET_DOMAIN) ,
                            'name'        => 'category_slug',
                            'placeholder' => __("Questions Category Slug", ET_DOMAIN) ,
                            'class'       => 'option-item bg-grey-input ',
                ...
                array(
                    'args' => array(
                        'title' => __("Questions Tag", ET_DOMAIN) ,
                        'id'    => 'questions-tag-slug',
                        'class' => 'list-package',
                        'desc'  => __("Enter slug for your Question Tag archive (this slug must be unique, please re-save the permalink options after changed slug).", ET_DOMAIN) ,
                    ) ,
                    'fields' => array(
                        array(
                            'id'          => 'tag-slug',
                            'type'        => 'text',
                            'title'       => __("Questions Tag Slug", ET_DOMAIN) ,
                            'name'        => 'tag_slug',
                            'placeholder' => __("Questions Tag Slug", ET_DOMAIN) ,
                            'class'       => 'option-item bg-grey-input ',
                            'default'     => 'qa-tag'
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("Questions Search", ET_DOMAIN) ,
                        'id'    => 'questions-search-slug',
                        'class' => 'list-package',
                    ) ,
                    'fields' => array(
                        array(
                            'id'          => 'category-slug',
                            'type'        => 'text',
                            'title'       => __("Questions Search Slug", ET_DOMAIN) ,
                            'name'        => 'search_slug',
                            'placeholder' => __("Questions Search Slug", ET_DOMAIN) ,
                            'class'       => 'option-item bg-grey-input ',
                ...
                array(
                    ...
                    'fields' => array(
                        array(
                            'id'          => 'members-slug',
                            'type'        => 'text',
                            'title'       => __("Members Slug Page", ET_DOMAIN) ,
                            'name'        => 'members_slug',
                            'placeholder' => __("Members Slug Page", ET_DOMAIN) ,
                            'class'       => 'option-item bg-grey-input ',
                            'default'     => 'member'
                        )
                    )
            ...
            'groups' => array(
                array(
                    'args' => array(
                        ...
                        'id'    => 'google-recaptcha',
                        'class' => '',
                        'desc'  => __("Enabling this will prevent spammers to register.<a href='https://www.google.com/recaptcha/admin#list' target='_blank' rel='nofollow'>get key</a>", ET_DOMAIN)
                    ) ,
                ...
                array(
                    'args' => array(
                        'title' => __("Google reCaptcha for Questions", ET_DOMAIN) ,
                        'id'    => 'google-recaptcha',
                        'class' => ''
                    ) ,
                    ...
                    'fields' => array(
                        array(
                            'id'    => 'gg_question_captcha',
                            'type'  => 'switch',
                            'title' => __("Enable Google reCaptcha for Questions-Null24.Net", ET_DOMAIN) ,
                            'name'  => 'gg_question_captcha',
                            'class' => ''
                        )
                    )
                ),
                // array(
                //     'args' => array(
                //         'title' => __("Google reCaptcha for Answers", ET_DOMAIN) ,
                //         'id'    => 'google-recaptcha',
                //         'class' => ''
                //     ) ,
                ...
                //     'fields' => array(
                //         array(
                //             'id'    => 'gg_answer_captcha',
                //             'type'  => 'switch',
                //             'title' => __("Enable Google reCaptcha for Answers", ET_DOMAIN) ,
                //             'name'  => 'gg_answer_captcha',
                //             'class' => ''
                //         )
                //     )
                // ),
            ...
            'groups' => array(
                array(
                    'args'  => array(
                        ...
                        'class' => '',
                        'name'  => '',
                        'desc'  => __("Your logo should be in PNG, GIF or JPG format, within 150x50px and less than 1500Kb.-Null24.Net", ET_DOMAIN)
                    ) ,
                ...
                array(
                    'args'  => array(
                        ...
                        'class' => '',
                        'name'  => '',
                        'desc'  => __("This icon will be used as a launcher icon for iPhone and Android smartphones and also as the website favicon. The image dimensions should be 57x57px.-Null24.Net", ET_DOMAIN)
                    ) ,
        ...
        $sections[] = array(
            ...
            'groups' => array(
                ...
                array(
                    ...
                    'fields' => array(
                        array(
                            'id'    => 'accept_answer_mail_template',
                            'type'  => 'editor',
                ...
                array(
                    'args' => array(
                        'title' => __("New Badges Mail Template", ET_DOMAIN),
                        'id'    => 'new-badges-mail',
                        'class' => '',
                        'name'  => ''
                    ),
                    'fields' => array(
                        array(
                            'id'    => 'new_badges_mail_template',
                            'type'  => 'editor',
                            'title' => __("New Badges Mail", ET_DOMAIN) ,
                            'name'  => 'new_badges_mail_template',
                            'class' => '',
                            'reset' => 1
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("Down Badges Mail Template", ET_DOMAIN),
                        'id'    => 'down-badges-mail',
                        'class' => '',
                        'name'  => ''
                    ),
                    'fields' => array(
                        array(
                            'id'    => 'down_badges_mail_template',
                            'type'  => 'editor',
                            'title' => __("Down Badges Mail", ET_DOMAIN) ,
                            'name'  => 'down_badges_mail_template',
                            'class' => '',
                            'reset' => 1
                        )
                    )
