    ...
    <div class="container">
        <div class="row">
            ...
            <ul class="list-categories sign-out-link">
                <li>
                    <a href="<?php echo esc_url( add_query_arg( 'edit', 'change-profile', get_author_posts_url( $current_user->ID )));?>"><?php _e("User Settings",ET_DOMAIN) ?></a>
                </li>
                <li>
            ...
            <a href="" class="toggle-list-categories">
                <i class="fa fa-chevron-circle-down"></i>
                <?php _e("List Categories", ET_DOMAIN) ?>
            </a>

            <ul id="menu-categories" class="list-categories">
                <?php
