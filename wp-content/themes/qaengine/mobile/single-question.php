...
<div class="wrapper-mobile">
    ...
    if( !is_user_logged_in()) {
        ...
        $permalink  = get_site_url() . '/intro?redirect=' . get_permalink();

        if( !ae_get_option( 'view-answer' ) ){  ?>
            <div class="sticky-wrapper">
                <h3 style="background: #E5E5E5; padding: 15px; font-size: 1.2em; text-align: center"><a class="login-url-cs" href="<?php echo $permalink; ?>"><?php _e('Login to post answer',ET_DOMAIN);?></a></h3>
            </div>
        <?php } else { ?>
            <div class="sticky-wrapper">
                <h3 style="background: #E5E5E5; padding: 15px; font-size: 1.2em; text-align: center"><a class="login-url-cs " href="<?php echo $permalink; ?>"><?php _e('Login or Register to view and post answer',ET_DOMAIN);?></a></h3>
            </div>
        <?php }?>
    <?php } ?>
            ...
            <div class="row">
            	<div class="col-md-12">
                    ...
                    <form class="form-post-answers" id="insert_answer" action="">
                        ...
                        <div class="form-post" id="answer_images_upload_container">
                            <a href="javascript:void(0)" id="answer_images_upload_browse_button"><i class="fa fa-image"></i><?php _e("Insert Image", ET_DOMAIN); ?></a>
                            <span class="et_ajaxnonce" id="<?php echo wp_create_nonce( 'et_upload_images' ); ?>"></span>
                            <span class="mobile_images_upload_text">
                            <?php
                            global $max_file_size;
                            printf( __("Size must be less than < %u MB.", ET_DOMAIN), $max_file_size );
                            ?>
